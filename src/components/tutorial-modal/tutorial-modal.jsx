...
const BASE_STEPS = [
    {
        ...
        description:
            "Un entorno de programación visual diseñado para aprender creando. " +
    ...
    {
        icon: "🔌",
        title: "Escenario y dispositivos",
        description:
            "En la parte superior encontrarás el Escenario, donde podrás ver cómo interactúan tus objetos y dispositivos." +
            "(En la parte inferior encontrarás) Debajo encontrarás el panel de configuración, donde podrás agregar y conectar dispositivos como PlayIoT o PlayMe para enviar comandos y empezar a programar.",
    ...
    },
    {
        ...
        description:
            "Aquí encontrarás todas las categorías de bloques para crear programas increíbles. " +
    ...
    },
    {
        ...
        description:
            "Este es el espacio donde crearás tus programas. " +
        ...
        targetSelector: '.blocklyMainBackground',
    },
    {
        icon: "🎉",
        title: "¡Todo listo para programar!",
        description:
            "Ahora ya conoces las principales herramientas de PlayCode. " +
...
const ZOOM_STEP = {
    ...
    description:
        "Tu pantalla es pequeña y parte de la interfaz puede quedar cortada. " +
...
const TutorialModal = ({ step, onNext, onSkip }) => {
    ...
    const handleNext = () => {
        if (
            ...
            window.innerWidth < ZOOM_THRESHOLD
        ) {
            setZoomWarning(true);
            return;
        }
    ...
    return (
        <div
            className={`${styles.overlay} ${spotlightRect ? styles.overlaySpotlight : ""}`}
        >
            {spotlightRect && (
                <div
